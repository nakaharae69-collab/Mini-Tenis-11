...
public class Juego extends JPanel {
    ...
    public Juego() {
        ...
        logica = new LogicaJuego(pelota, raqueta, tiempo);

        sonido = new GestorSonido(Sound.BACK, Sound.GAMEOVER);

        setTextosIdioma();

        // ⌨️ CONTROL TECLADO SEPARADO
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString(textoRonda + tiempo.getRonda(), 10, 45);
    ...
    // 🔁 getters usados por ControlTeclado y lógica
